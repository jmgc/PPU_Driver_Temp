 ...
 * if the ethernet interface is used. If the ECM is used, the address shall be
 * different, as this is the mac adress of the other node.
 * IMPORTANT: The descriptor should be different from the address as the
 * descriptor is used as the host MAC, while the MAC address is used by the
 * microcontroller.
 */
...
#define CDC_ECM_MAC_ADDR5                            0x01U /* 00 */
