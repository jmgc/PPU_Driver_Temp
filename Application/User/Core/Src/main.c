...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_7, GPIO_PIN_SET); // <-- SELECT_P
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_8, GPIO_PIN_SET); // <-- SELECT_N
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_9, GPIO_PIN_SET); // <-- SELECT_I
}
